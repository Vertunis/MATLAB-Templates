 ...
 90+theta(3),         0,                 0,  90; %Transformation Joint 2-3 
    ...
    theta(6),0.065+0.01,                 0,   0; %Transformation Joint 5-6 Handflansch (mit Adapter 0,01m)        
          ...
          90,         0,           0.017/2, -90; %Transformation Joint 7-8
           0,      0.15,                 0,   0; %Transformation Joint 8-9 TCP Gießschnauze Flasche P
...
T89=DenavitTrafo2(DH_Par(9,1),DH_Par(9,2),DH_Par(9,3),DH_Par(9,4)); % TCP des Greifers unter berücksichtigung der Greifer Geometrie
