...
load Rec2pos/2016_06_19_P_rec % -> TCP_pos_m (hat unterschiedliche viele Einträge mit dT = 0.004s)
pos_measure=TCP_pos_m;
load Simulationsdaten/Position_P_sim % -> pos_sim (besitzt 7500 Einträge bei einer Dauer von 70s und einer dT=0.01s)
pos_sim=Roboterinfo_pos;
    
    case 2 
% Laden Position R transformierten Recorderdaten und Simulation
load Rec2pos/2016_06_19_R_rec % -> R_pos_m (hat unterschiedliche viele Einträge mit dT = 0.004s)
pos_measure=R_pos_m;
load Simulationsdaten/Position_R_sim % -> pos_sim (besitzt 7500 Einträge bei einer Dauer von 70s und einer dT=0.01s)                  
pos_sim=Roboterinfo_pos;
...
t_offset=2 % Zeitliches Offset der Messungen in Sekunden
