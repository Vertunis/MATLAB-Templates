...
save('Rec2Pos/2016_06_08_Achswinkel_mat','valueTable');
...
T1011=DenavitTrafo2(DH_Par(11,1),DH_Par(11,2),DH_Par(11,3),DH_Par(1,4)); % TCP des Greifers unter berücksichtigung der Greifer/Flasche Geometrie
...
save('Rec2Pos/2016_06_19_P_rec','TCP_pos_m');
save('Rec2Pos/2016_06_19_R_rec','R_pos_m');
