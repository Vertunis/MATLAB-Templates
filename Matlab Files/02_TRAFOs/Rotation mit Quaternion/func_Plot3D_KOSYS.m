function func_Plot3D_KOSYS(fig,n,x,y,z)
% func_Plot3D_KOSYS(fig,n,x,y,z) -
% fig = Handlernummer für Plot
% n = (n1;n2;n3)Vektor der zusätzlich geplottet werden soll 
% x,y,z Angabe der Weite des zu plottenden KOSYS

% 3-D Plot Koordinatensystem

% Endpunkte
s=1;% Spannweite KOSYS
...
xlim=[-x x]; % Begrenzungen x
ylim=[-y y]; % Begrenzungen y
zlim=[-z z]; % Begrenzungen x
...
% Hier wird der Vektor geplottet bezüglich des Urpsrungs
plot3([O_orig(1) n(1)],[O_orig(2) n(2)] ,[O_orig(3) n(3)],'-','Color',[0 0 0]/255,'LineWidth',1) 
